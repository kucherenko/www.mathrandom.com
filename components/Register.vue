          ...
          <div
            ...
            <div class="relative p-6 flex-auto">
              <label v-if="step === 1" class="block">
                <p v-if="serverError" class="text-hot-red mb-2">Server error, can't subscribe to the list, try
                  again.</p>
              ...
              <div v-if="step === 2" class="block p-3 transition lg:p-6">
                <add-to-calendar :title="'Math.random() community event'"
                                 :location="event.link"
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    <google-calendar id="google-calendar">
                      <img src="@/assets/img/icons/google-calendar.svg" class="inline w-20 h-20" />
                      Add to Google calendar
                    </google-calendar>

                    <microsoft-calendar id="microsoft-calendar">
                      <img src="@/assets/img/icons/outlook.svg" class="inline w-20 h-20" />
                      Add to Microsoft live calendar
                    </microsoft-calendar>

                    <office365-calendar id="office365-calendar">
                      <img src="@/assets/img/icons/office-365.svg" class="inline w-20 h-20" />
                      Add to Office365 outlook calendar
                    </office365-calendar>
                    <div>
                      <a :href="location">
                        <img src="@/assets/img/icons/youtube.svg" class="inline w-20 h-20" />
            ...
            <div class="flex items-center justify-end p-6 rounded-b">
              <button
                ...
                type="submit">
                <svg v-if="loader" class="animate-spin mb-1 mr-3 h-5 w-5 text-gray-500 inline"
